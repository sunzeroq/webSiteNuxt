						...
						<div class="content-wrapper-header">
							<div class="content-wrapper-context">
								...
								<div class="content-text">
									Grab yourself 10 free images from Adobe
									Stock in a 30-day free trial plan and find
									perfect image, that will help you with your
									new project.
								</div>
									...
									<div class="button-wrapper">
										...
										<div class="pop-up">
											...
											<div class="pop-up__subtitle">
												Adjust your selections for
												advanced options as desired
												before continuing.
												<a href="#">Learn more</a>
											</div>
						...
						<div class="content-section">
							...
							<div class="apps-card">
								...
								<div class="app-card">
									...
									<div class="app-card__subtext">
										Design and publish great projects &
										mockups
									</div>
									<div class="app-card-buttons">
										<button
								...
								<div class="app-card">
									...
									<div class="app-card__subtext">
										Industry Standart motion graphics &
										visual effects
									</div>
									<div class="app-card-buttons">
										<button
